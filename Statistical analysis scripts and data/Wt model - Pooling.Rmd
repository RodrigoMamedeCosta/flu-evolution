...
```{r Subset for including stock and excluding unfamiliar and 1XP:}
...
```{r Leveling - relevel to test pooling on each host}
...
```{r 1X 2X 4X in each host separately}
# Levels to iterate over
hosts <- c("BALBF", "BALBM", "BL6F")
...
```{r 1XP vs 1X tests, all strains, familiar.}
