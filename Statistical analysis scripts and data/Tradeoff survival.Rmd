...
Remove stock virus and 2X since BL6 UNF doesn't have it.
```{r Remove stock virus}
survdata <- subset(survdata, Treatment !="STOCK" & Treatment != "1XP" & Treatment != "2X" & Sex =="F")
...
HostFam=BALBF_FAM 14        8    10.14     0.452      1.35
HostFam=BALBF_UNF 14       10     7.86     0.583      1.35

 Chisq= 1.3  on 1 degrees of freedom, p= 0.2 
Chi-squared: 1.348554 
P-value: 0.2455 
...
survdiff(formula = surv_obj ~ HostFam, data = tradeoffs_subset)
                  ...
                  N Observed Expected (O-E)^2/E (O-E)^2/V
HostFam=BL6F_FAM 14        3     1.44      1.68      3.24
HostFam=BL6F_UNF 14        0     1.56      1.56      3.24

 Chisq= 3.2  on 1 degrees of freedom, p= 0.07 
Chi-squared: 3.240122 
P-value: 0.07186 
Degrees of Freedom: 1 
...
hostmort <- subset(survdata, Treatment != "1XP" &  Treatment != "1XP" & Sex =="F")
